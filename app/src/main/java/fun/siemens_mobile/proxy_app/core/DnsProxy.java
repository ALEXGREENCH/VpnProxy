...
import fun.siemens_mobile.proxy_app.dns.Question;
import fun.siemens_mobile.proxy_app.dns.Resource;
import fun.siemens_mobile.proxy_app.dns.ResourcePointer;
